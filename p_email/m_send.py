...
from p_filter.m_filter import comidas_semana
from p_filter.m_filter import cenas_semana
from p_filter.m_filter import comidas_finde
from p_filter.m_filter import cenas_finde
...
# Compose the email using the previously selected recipe choices
